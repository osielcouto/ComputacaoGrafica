function main()
{
  ...
  // left side cylinder
  var cylinderGeometry3 = new THREE.CylinderGeometry(0.05, 0.05, 0.8, 25);
  var cylinderMaterial3 = new THREE.MeshPhongMaterial( {color:'rgb(200,190,0)'} );
  var cylinder3 = new THREE.Mesh( cylinderGeometry3, cylinderMaterial3 );
  cylinder2.add(cylinder3);

  // right side cylinder
  var cylinderGeometry4 = new THREE.CylinderGeometry(0.05, 0.05, 0.8, 25);
  var cylinderMaterial4 = new THREE.MeshPhongMaterial( {color:'rgb(200,190,0)'} );
  ...
  function buildInterface()
  {
    ...
    gui.add(controls, 'speed', 0.0, 0.05)
